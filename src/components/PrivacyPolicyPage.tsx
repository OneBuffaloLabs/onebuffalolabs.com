    ...
    <div className='bg-gray-50 text-gray-800 font-sans'>
      <div className='max-w-4xl mx-auto px-6 py-16 pt-28'>
        <div className='space-y-6'>
          ...
          <h2 className='text-3xl font-bold text-[var(--obl-blue)] border-b pb-2 mt-10'>
            Interpretation and Definitions
          </h2>
          <h3 className='text-2xl font-semibold text-gray-800 pt-4'>Interpretation</h3>
          <p className='leading-relaxed'>
            The words of which the initial letter is capitalized have meanings defined under the
            following conditions. The following definitions shall have the same meaning regardless
            of whether they appear in singular or in plural.
          </p>
          <h3 className='text-2xl font-semibold text-gray-800 pt-4'>Definitions</h3>
          <p className='leading-relaxed'>For the purposes of this Privacy Policy:</p>
          <ul className='list-disc list-outside space-y-3 pl-5 leading-relaxed'>
            <li>
            ...
            <li>
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to One
              Buffalo Labs, Buffalo, NY.
            </li>
            <li>
          ...
          <h3 className='text-2xl font-semibold text-gray-800 pt-4'>Types of Data Collected</h3>
          <h4 className='text-xl font-semibold text-gray-700 pt-2'>Personal Data</h4>
          <p className='leading-relaxed'>
          ...
          <h4 className='text-xl font-semibold text-gray-700 pt-2'>Usage Data</h4>
          <p className='leading-relaxed'>
